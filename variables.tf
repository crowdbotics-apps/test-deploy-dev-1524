variable "app_name" {
  ...
  type = "string"
  default = "test-deploy-dev-1524"
}

variable "custom_domain" {
  description = "Custom domain name (optional)"
  type = "string"
  default = "test-deploy-dev-1524.botics.co"
}
...
variable "repo_url" {
    ...
    type = "string"
    default = "https://github.com/crowdbotics-apps/test-deploy-dev-1524/archive/master.tar.gz"
}
